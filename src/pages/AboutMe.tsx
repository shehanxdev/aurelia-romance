...
export function AboutMe() {
  return (
    <div className="flex flex-col">
      ...
      <div className="w-[90%] leading-none flex flex-col m-auto">
        <Text as="h1" variant="headingxl">
          About
          <br />
          <span className="text-primary">Aurelia <br /> Romance</span>
        </Text>
      ...
      <div className="w-[90%] leading-none flex flex-col m-auto mt-[120px] md:mt-[200px] mb-[40px]">
        <Text as="h1" variant="headingxl">
          Explore <br /> Services
        </Text>
      </div>
